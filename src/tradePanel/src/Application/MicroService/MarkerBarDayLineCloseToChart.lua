--- MicroService MarkerBarDayLineCloseToChart

local MicroService = {
    --
    name = "MicroService_MarkerBarDayLineCloseToChart",
    ...
    -- массив инструментов по которым будет обновляться локация (включённые в markerVolume)
