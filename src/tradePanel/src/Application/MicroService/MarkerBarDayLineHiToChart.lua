--- MicroService MarkerBarDayLineHiToChart

local MicroService = {
    --
    name = "MicroService_MarkerBarDayLineHiToChart",
    ...
    getLineVertical = function(self, idStock)
        local lineVertical = self.entityServiceDsD:getHiLowClosePreviousBar(idStock).hi
