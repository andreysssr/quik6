--- MicroService MarkerBarDayLineLowToChart

local MicroService = {
    --
    name = "MicroService_MarkerBarDayLineLowToChart",
    ...
    getLineVertical = function(self, idStock)
        local lineVertical = self.entityServiceDsD:getHiLowClosePreviousBar(idStock).low
