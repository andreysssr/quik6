--- MicroService MarkerBarHourLineLowToChart

local MicroService = {
    --
    name = "MicroService_MarkerBarHourLineLowToChart",
    ...
    getLineVertical = function(self, idStock)
        ...
        if class == "TQBR" or class == "CETS" then
            lineVertical = self.entityServiceDsH1:getHiLowBarHour10(idStock).low
        elseif class == "SPBFUT" then
            lineVertical = self.entityServiceDsH1:getHiLowBarHour9(idStock).low
        end
