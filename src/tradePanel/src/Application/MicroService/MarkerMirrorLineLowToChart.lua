--- MicroService MarkerMirrorLineLowToChart

local MicroService = {
    --
    name = "MicroService_MarkerMirrorLineLowToChart",
    ...
    new = function(self, container)
        ...
        self.handlerMirrorLine = container:get("Handler_MirrorLineToChart")
    ...
    updateArrayIdStock = function(self)
        self.trendIdStock = self.microserviceConditionPanelTrade:getMarkerMirrorLineHiLowListTrue()
    end,
    ...
    getLineVertical = function(self, idStock)
        return self.handlerMirrorLine:getMirrorLineLow(idStock)
    end,
