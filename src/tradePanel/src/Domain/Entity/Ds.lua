...
local Entity = {
    ...
    -- удал€ет источник данных, отписываетс€ от получени€ данных
    ...
    -- провер€ет - обновилс€ ли бар
    -- если бар обновилс€ - создаЄтс€ событие
    ...
    -- вернуть √эп
    -- (вчерашнее закрытие) - (сегодн€шнее открытие)
    -- абсолютна€ величина
    ...
    -- ATR от вчерашнего закрыти€
    -- (вчерашнее закрытие) - (текуща€ цена)
    ...
    -- вернуть объЄм последних 3 баров
    ...
    -- вернуть hi, low, close предыдущего дн€
    ...
    -- дл€ часовика (9 часов - дл€ фьючерсов)
